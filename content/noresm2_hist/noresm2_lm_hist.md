...
this simulation was run with FLUX SCHEME=0. and d ALB COSZ AVG=.false. A comparison of AMIP simulations with and without these settings can be found here:
